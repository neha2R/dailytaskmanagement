        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        <a href="{{ route('dpHead.dashboard') }}" class="nav-link">
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="advanced-ui" style="">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('dpHead.inventory-management.index') }}"
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="trips-cons" style="">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('dpHead.consignements.index') }}"
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse " id="vehicle_dropdown">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('dpHead.vehicles.index') }}" class="nav-link ">Vehicles</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('dpHead.fule-management.index') }}" class="nav-link ">Fuel</a>
                                </li>
                            </ul>
                        </div>
                    </li>
