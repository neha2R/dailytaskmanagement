                    ...
                    <tbody>
                        @foreach ($fuelsData as $key => $item)
                            <tr>
                                ...
                                <td>{{ $item->warehouse_id ? $item->warehouse->name : $item->depo->name ?? '-' }}</td>
                                ...
                                <td>
                                    <div class="dropdown mb-2">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                                            <a type="button"
                                                onclick="viewFuelDetails('{{ route('admin.fule-management.show', $item->id) }}')"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form id="add-fuel-form" action="{{ route('admin.fule-management.store') }}" method="POST"
                            ...
                            <div class="row gx-5 mb-3">
                                <div class="col-12">
                                    ...
                                    <select style="width: 100%;" name="vehicle_id" id="vehicle_id"
                                        ...
                                        @foreach ($activeVehicles as $item)
                                            <option value="{{ $item->id }}">{{ $item->vehicle_number }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-unstyled">
                                            ...
                                            <li><strong>Warehouse/Depo:</strong></li>
                                            <li><strong>Added By:</strong></li>
                                    ...
                                    <div class="col-md-6">
                                        <ul class="list-unstyled">
                                            ...
                                            <li>${data.driver ? data.driver.name : "-"}</li>
                                            <li>${data.warehouse ? data.warehouse.name : (data.depo ? data.depo.name : '-')}</li>
