                ...
                <div class="card-body">
                    <div class="d-flex flex-column">
                        @foreach ($history as $item)
                            <a style="cursor: auto;" href="javascript:;"
                                ...
                                <div class="w-100">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="fw-normal text-body mb-1 mt-3">{{ $item->user->name }}</h6>
                                        <div class="mt-3">
                                            @switch($item->action)
                                                @case('Stocked')
                                    ...
                                    @switch($item->action)
                                        @case('Stocked')
                                            <p class="text-muted tx-13">Added {{ $item->quantity }}
                                                {{ $item->product->uom->name ?? '-' }} of
