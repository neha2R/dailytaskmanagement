        ...
        <div class="col-8">
            <div class="card mb-3 pb-3">
                <div class="card-header d-flex justify-content-between align-items-center px-2 py-2 ">
                    <h5 class="">Consignment Details</h5>
                </div>
                <div class="card-body p-0 pt-2">
                    <div class="row">
                        <div class="">
                            <ul class="d-flex list-unstyled text-center v_heading">
                                <li class="text-capitalize  col">Consignment No</li>
            ...
            <div class="card">
                ...
                <div class="card-body pb-1">
                    <form method="POST" id="checkout-form" action="{{ route('whHead.inventory-management.store') }}">
                        @csrf
                                ...
                                @if ($consignment->delivery_challan)
                                    <tr>
                                        ...
                                        <td class="text-end"><button
                                                onclick="viewChallan('{{ route('whHead.getChallan', $consignment->delivery_challan->id) }}')"
            ...
            <div class="card mb-3">
                ...
                <div class="card-body scrollable-tbody pt-2 pb-2">
                    <table class="table">
                        <thead>
                            <tr>
                                <th class="text-start">Consignment</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($consignment->pods)
                                <tr>
                                    <td class="text-start">{{ env('PrefixCon') . $consignment->id }}</td>
                                    <td class="text-end"><button
                                            onclick="viewChallan('{{ route('whHead.getChallan', $consignment->pods->id) }}')"
                                            class="btn btn-xs btn-success">view</button></td>
                                </tr>
                            @else
                                <tr>
                        ...
                        <tbody>
                            @if ($consignment->eway_bill)
                                <tr>
                                    ...
                                    <td class="text-end"><button
                                            onclick="viewBill('{{ route('whHead.getBill', $consignment->eway_bill->id) }}')"
                                            class="btn btn-xs btn-success">view</button></td>
                                </tr>
                            @else
                                <tr>
