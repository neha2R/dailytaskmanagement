...
$(document).ready(function(){
    /*Doughnut chart*/
    var ctx = document.getElementById("myChartcomplaint");
    var complaintstats = document.getElementById("complaintstats").value;
    complaintstats = JSON.parse(complaintstats)
    var data = {
        labels: [
            "Highpriority Complaint", "Active Complaint", "Resolved Complaint", "Crossed Timeline"
        ],
        datasets: [{
            data: complaintstats,
            backgroundColor: [
    ...
    /*Doughnut chart*/
    var ctx = document.getElementById("myChartinquiry");
    var inquirystats = document.getElementById("inquirystats").value;
    inquirystats = JSON.parse(inquirystats)
    var data = {
        labels: [
            "Active Inquiry", "Resolved Inquiry "
        ],
        datasets: [{
            data: inquirystats,
            backgroundColor: [
