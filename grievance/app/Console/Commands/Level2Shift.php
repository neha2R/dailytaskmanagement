...
class Level2Shift extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:level2shift';
    ...
    {
        $data =  Transition::where(['tolevel'=>2,'is_transfered'=>0])->where('created_at', '>', Carbon::now()->subMinutes(200)->toDateTimeString())->get();
