    ...
    <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <form class="md-float-material form-material" method="POST" action="{{route('handelresetpassword')}}">
                    @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" class="form-control" required="" placeholder="Your Email Address" name="email">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <img src="..\files\assets\images\auth\Logo-small-bottom.png" alt="small-logo.png" style="max-width: 110%;">
                                    </div>
                                </div>
                            </div>
                        </div>
