                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left">Password Reset</h3>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-12">
                                        <p>If we have recognised your account, an email will be sent to allow you to reset your password. If you do not receive that email, then please contact support.</p>
                                    </div>
                                </div>
