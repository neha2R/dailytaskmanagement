                            ...
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown" id="notificationdiv">
                                    <div class="dropdown-toggle" data-toggle="dropdown" id="dropdowntoggle">
                                        ...
                                        <span class="badge bg-c-pink" id="badge">{{countofnotification(auth()->user()->id)}}</span>
                                    </div>
                                    <ul class="show-notification notification-view dropdown-menu complaintnoti" data-dropdown-in="fadeIn" style="height:300px; overflow-y:scroll;" data-dropdown-out="fadeOut" id="notificationbox">
                                        <li id="fixedli">
                                            <h6>Notifications</h6>
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        <li>
                                            <a href="{{route('seniorprofile')}}">
                                                <i class="feather icon-user"></i> Profile
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{route('seniorchangepassword')}}">
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                {{-- <li class="">
                                    <a href="{{route('scomplaint')}}">
                                        <span class="pcoded-micon"><i class="feather icon-menu"></i></span>
                                        <span class="pcoded-mtext">Complaints</span>
                                    </a>
                                </li> --}}
                                <li class="">
                                    <a href="{{route('sinquiry')}}">
                                        <span class="pcoded-micon"><i class="feather icon-menu"></i></span>
                                        <span class="pcoded-mtext">Inquiry</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="{{route('closecomplaints')}}">
                                        <span class="pcoded-micon"><i class="feather icon-menu"></i></span>
                                        <span class="pcoded-mtext">Close Complaint</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="{{route('closeinquirys')}}">
                                        <span class="pcoded-micon"><i class="feather icon-menu"></i></span>
                                        <span class="pcoded-mtext">Close Inquiry</span>
                                    </a>
                                </li>
                            </ul>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{URL::asset('files\bower_components\bootstrap-multiselect\js\bootstrap-multiselect.js')}}"></script>
    ...
    <script>
        ...
        var channel = pusher.subscribe('complaint-transfer');
        var channel2 = pusher.subscribe('inquiry-transfer');
        var userid = $('#userid').val();
        var channelname = 'complainttransfer'+userid;
        var channel2name = 'inquirytransfer'+userid;
        ...
        channel2.bind(channel2name, function(data) {
            appendnotification(data);
        });
